...
import alice.sniper.cn.alice.Say.Say;
...
public class Thought extends Thread{
    ...
    /**
     * 声明大脑的说话接口 BrainSay -> Say 接口
     */
    private static BrainSay.ToastSay brainSay;
    ...
    public static void BrainSay(BrainSay.ToastSay brainSay){
